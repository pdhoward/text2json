...
// function to convert a test file to a json doc
// note that this is highly customized, handling specific conditions
// encountered in the test text data
var lineNr = 0;
            ...
            .pipe(es.mapSync( async function(line){
                ...
                if (n !== 0) {
                    ...
                    if (y !== -1) {
                        ...
                        // first remove any illegal characters especially " (ie inch)
                        line = line.replace(/[|&;$%@"<>()+,]/g, "");               
...
// Connect to mongo server and commence execution
